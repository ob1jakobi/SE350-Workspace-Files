...
public class Airline {
     ...
     * @throws IllegalArgumentException if the name of the airline is <1 or >8 characters in length (inclusive).
    ...
    private void airlineNameValidator(String airlineName) throws IllegalArgumentException, NullPointerException {
        ...
        if (airlineName.length() <= 0 || airlineName.length() >= 8) {
            throw new IllegalArgumentException("Please enter a name that is <1 or >8 characters in length.");
        }
     ...
     * @throws IllegalArgumentException if the Airline name is <1 or >8 characters in length.
